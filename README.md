Ohio State Buckeyes football tracker — schedule, roster, news, odds, rankings, and gameday weather.
...
- Rankings: ESPN's AP Top 25 poll endpoint. Shows Ohio State's current rank and highlights ranked opponents on the schedule. Off-season/preseason it'll reflect the most recent poll available (e.g. last season's final poll) until the next one is released.
